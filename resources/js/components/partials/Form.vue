        ...
        <div class="container mt-5 p-0">
            ...
            <div class="form-group mt-5">
                ...
                <div class="card-body">
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-default dropdown-toggle shadow-none w-auto select-picker text-capitalize fs-4" :class="disableType ? 'bg-secondary bg-opacity-50 border-0 text-dark fw-bolder' : ''" id="type" :disabled="disableType" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul v-if="!disableType" class="dropdown-menu" style="min-width: auto;" aria-labelledby="type">
                            <li><a class="dropdown-item" data="LI" @click="handleSelect">Logistic Instruction</a></li>
                            <li><a class="dropdown-item" data="SI" @click="handleSelect">Service Instruction</a></li>
                        </ul>
                    </div>
                    <div class="col"></div>
                    <div class="col-1">
                    ...
                    <div class="col-8 pb-3 border-end border-secondary border-opacity-50">
                        ...
                        <Select
                            ...
                            :create-placeholder="!!form['assigned_vendor'] ? 'Add New Vendor Address' : undefined"
            ...
            <div class="form-group mt-5">
                ...
                <div class="card-body d-flex justify-content-end">
                    <button type="button" @click="() => {$router.back()}" class="btn btn-light me-3">
                    Cancel
                    </button>
                    <button type="button" @click="$emit('handleDraft', form)" class="btn btn-secondary me-3">
                    Save as Draft
                    </button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      postAddress(form) {
        this.$store.dispatch("postVendorAddress", {form: form, id: this.vendor.id});
      },
    },
    beforeMount() {
