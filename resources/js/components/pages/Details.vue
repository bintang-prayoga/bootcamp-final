        ...
        <div class="container-fluid mt-5">
            ...
            <div class="container mt-5">
                <div class="form-group row mt-5">
                    ...
                    <div class="col-2">
                        <label class="text-muted fs-5 fw-light"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-2">
                        ...
                        >
                        <p class="fs-3 fw-bold">
                            {{ this.details.assigned_vendor }}
                        </p>
                    </div>
                    <div class="col-2">
                        <label class="text-muted fs-5 fw-light"
                            >Vendor Quotation No.</label
                        >
                        <p class="fs-3 fw-bold">
                            {{ this.details.quotation_no }}
                        </p>
                    </div>
                    <div class="col-5">
                        <label class="text-muted fs-5 fw-light"
                ...
                <div class="row mt-5">
                    ...
                    <table class="table fs-4">
                        ...
                        <tbody>
                            <tr
                                v-for="(item, index) in details.costs"
                                :key="index"
                            >
                                <td>
                ...
                <div class="row mt-5 d-flex justify-content-between">
                    <div class="w-50">
                        ...
                        >
                            ...
                            />
                            <div class="mx-3 mt-0">
                                <p class="fs-3 my-0 text-info fw-bold">
                                    Nama File.pdf
                                </p>
                                <p>author, waktu</p>
                            </div>
                ...
                <div class="row w-100 bg-dark-gray">
                    <p class="my-2 ms-4 text-white fs-3 fw-bold">
                        For Internal Only
                    </p>
                </div>
