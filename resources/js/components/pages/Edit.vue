      ...
      <div class="container-fluid mt-5">
        ...
        <div class="container mt-5 p-0">
          <div>
            ...
            />
            <form method="post" v-on:submit.prevent="$store.dispatch('updateInstruction', {form: form, id: $route.params.id})">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row my-3 justify-content-between">
                      <div class="col-3">
                        <button type="button" class="btn btn-default dropdown-toggle shadow-none w-auto select-picker text-capitalize fs-4 bg-secondary bg-opacity-50 border-0 text-dark fw-bolder" id="type" disabled>
  ...
  export default {
    ...
    methods: {
      ...
      saveAsDraft() {
          ...
          this.$store.dispatch("updateInstruction", {form: this.form, id: this.$route.params.id});
      }
    },
    beforeMount() {
      ...
      formCopy: {
        ...
        handler(newValue, oldValue) {
            ...
            if(newValue.assigned_vendor != oldValue.assigned_vendor){
                if(oldValue.assigned_vendor ?? false){
